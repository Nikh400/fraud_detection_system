...
class ImageModel:
    """
    Lightweight image-based fraud classifier.
    ...
    Input:
        Preprocessed grayscale image flattened into vector.
    ...
    def train(
        ...
        for epoch in range(epochs):
            ...
            if verbose and epoch % 5 == 0:
                ...
                print(f"[ImageModel] Epoch {epoch}: accuracy={acc:.3f}")
